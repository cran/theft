...
#' 
#' @importFrom rlang .data as_function is_bool abort warn
#' @importFrom stats IQR cor dist hclust median prcomp reorder sd t.test glm binomial wilcox.test ecdf pnorm formula predict
#' @import Rcatch22
